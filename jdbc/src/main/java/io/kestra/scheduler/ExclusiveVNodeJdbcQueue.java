...
public class ExclusiveVNodeJdbcQueue<T> extends AbstractJdbcQueue<T> {
    
    private static final Logger log = LoggerFactory.getLogger(ExclusiveVNodeJdbcQueue.class);
    
    @Inject
    public ExclusiveVNodeJdbcQueue(JooqDSLContextWrapper dslContextWrapper,
