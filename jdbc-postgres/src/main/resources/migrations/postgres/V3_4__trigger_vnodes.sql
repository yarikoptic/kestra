...
ALTER TABLE triggers
    ADD COLUMN vnode INT GENERATED ALWAYS AS (JSON_UNQUOTE(JSON_EXTRACT(value, '$.vnode'))) STORED,
    ADD COLUMN locked BOOLEAN GENERATED ALWAYS AS (JSON_UNQUOTE(JSON_EXTRACT(value, '$.locked'))) STORED;
