...
/**
 * Service interface for computing next evaluation date.
 */
public interface NextEvaluationDate {
     ...
     */
    static ZonedDateTime get(Clock clock, AbstractTrigger trigger, TriggerContext triggerContext, ConditionContext conditionContext) throws InvalidTriggerConfigurationException {
     ...
     * @throws InvalidTriggerConfigurationException if something bad happens while computing next evaluation date.
     */
    static ZonedDateTime get(Clock clock, AbstractTrigger trigger) throws InvalidTriggerConfigurationException {
        ZonedDateTime nextExecutionDate;
        if (trigger instanceof PollingTriggerInterface pollingTrigger) {
